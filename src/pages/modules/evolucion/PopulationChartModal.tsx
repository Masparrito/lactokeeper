    ...
    <div className="h-[calc(90vh-160px)] w-full p-4"> {/* Altura ajustada */}
      <ResponsiveContainer width="100%" height="100%">
        <AreaChart data={data} margin={{ top: 5, right: 0, left: 0, bottom: 5 }} stackOffset="none">
          ...
          <XAxis dataKey="monthIndex" tick={{ fontSize: 12, fill: '#64748b' }} tickLine={false} axisLine={false} tickFormatter={formatXAxis} padding={{ left: 10, right: 10 }} />
    ...
    >
      ...
      >
        ...
        <header className="flex items-center justify-between p-4 border-b border-c-border flex-shrink-0">
          <h1 className="text-xl font-bold text-c-text-strong">{title}</h1>
          <button
            onClick={onClose}
            title="Cerrar"

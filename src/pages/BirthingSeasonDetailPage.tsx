...
                <h1 className="text-2xl text-c-text-muted">Temporada de Partos no encontrada.</h1>
                <button onClick={onBack} className="mt-4 text-c-accent">Volver</button>
            </div>
        );
    }
...
                    <h1 className="text-3xl font-bold tracking-tight text-c-text">{seasonForecast.seasonName}</h1>
                    <p className="text-lg text-c-text-muted">Detalle de Proyección de Partos</p>
                </div>
                <div className="w-8"></div>
            </header>

            <div className="bg-c-surface backdrop-blur-xl rounded-2xl p-4 border border-c-border">
                <h3 className="flex items-center gap-2 text-lg font-semibold text-c-text mb-4"><BarChart2 size={20}/> Proyección Semanal de Partos</h3>
...
                            <Tooltip cursor={{fill: 'rgba(0, 0, 0, 0.05)'}} contentStyle={{ backgroundColor: 'rgba(44, 44, 46, 0.8)', border: '1px solid #444', borderRadius: '12px' }} />
                            <Bar dataKey="partos" name="Nº de Partos" fill="#3E9C4F" radius={[4, 4, 0, 0]} />
                        </BarChart>
                    </ResponsiveContainer>
                </div>
            </div>

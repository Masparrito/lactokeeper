...
        	 	 	 	 	 	 <button onClick={resetFilters} className="flex-shrink-0 p-2 rounded-xl border border-zinc-700 bg-zinc-800 text-zinc-300 hover:bg-zinc-700"><FilterX size={16}/> <span className='ml-1 text-sm'>Limpiar Filtros</span></button>

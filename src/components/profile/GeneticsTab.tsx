    ...
    return (
        <div className="space-y-4">
            <div className="flex justify-between items-center">
                <p className="text-sm text-c-text-muted">Desliza el gráfico para ver más →</p>
                <button
                    onClick={onExportPDF}
                    disabled={isExporting}
                    className="flex items-center gap-2 bg-c-surface-2 hover:bg-c-surface-2 text-c-text font-semibold py-1.5 px-3 rounded-lg transition-colors text-sm disabled:opacity-50"
                >
                    <Printer size={16} />
            ...
            <div className="overflow-x-auto bg-c-surface-2 rounded-lg p-2">
                <PedigreeChart
                    rootNode={rootNode}

      ...
      <div className="space-y-6">
            ...
            <div className="space-y-2">
              {recentSessions.map((date) => (
                ...
                <button
                    ...
                    className="w-full text-left bg-c-surface-2 p-3 rounded-xl hover:bg-c-surface-2 transition-colors flex justify-between items-center"
                >
        ...
        <div>
          ...
          <button
            ...
            className="w-full text-left bg-c-accent/15 border border-c-accent/80 p-4 rounded-xl hover:bg-c-accent/30 transition-colors flex justify-between items-center"
          >
            <span className="text-lg font-bold text-c-text">Construir Carga Masiva...</span>
            <ChevronRight size={20} className="text-c-accent" />
          </button>
           {/* Helper text */}
        ...
        {isReadyForMatingAction && (
            <div className="pt-4 border-t border-c-border">
                <h3 className="text-sm font-semibold text-c-text-muted mb-2">Acciones de Desarrollo</h3>
                <div className="flex">
